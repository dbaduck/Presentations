...
Get-DbaDatabase -SqlInstance localhost -Database dba
$db = Get-DbaDatabase -SqlInstance localhost -Database dba
$db.GetType()
...
Cd "SQLSERVER:\SQL\LOCALHOST\DEFAULT\Databases\DBA\Tables"
dir
