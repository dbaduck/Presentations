...
$server.Databases.Name -contains "a"
...
# with enable
Add-SqlLogin -LoginType SqlLogin -ServerInstance $ServerInstance -LoginPSCredential (Get-Credential) -Script
...
$var = Get-SqlLogin -ServerInstance $serverinstance -LoginName sabob 
...
Copy-DbaLogin -Source $ServerInstance -Destination "10.0.1.31" -DestinationSqlCredential (get-credential) -ExcludeSystemLogins
...
Get-DbaDbFile -SqlInstance $SErverInstance -Database DEMODB
